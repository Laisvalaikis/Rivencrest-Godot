...
public partial class InputManagerOld: Node2D
{
	...
	public override void _UnhandledInput(InputEvent @event)
	{
		...
		// 	}
		// }
		// else if (CurrentInputScheme == InputScheme.GamePad)
		// {
	...
	{
		if (CurrentInputScheme == InputScheme.GamePad)
		{
			EmitSignal("DisableSelector", _mousePosition);
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		if (CurrentInputScheme == InputScheme.GamePad)
		{
			    ...
			    Input.IsActionPressed("CameraMovementRight", true) || Input.IsActionPressed("CameraMovementLeft", true))
			{
				...
				relativePosition = Input.GetVector("CameraMovementRight", "CameraMovementLeft", "CameraMovementDown",
					"CameraMovementUp");
