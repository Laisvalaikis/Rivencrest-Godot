...
[Serializable]
	...
	public class SavableCharacter
	{
		...
		public List<UnlockedBlessings> baseAbilityBlessings { get; set; }
		...
		public SavableCharacter(int level, int xP, int xPToGain, bool dead, string characterName,
			int abilityPointCount, List<UnlockedAbilities> unlockedAbilities, int toConfirmAbilities, List<UnlockedBlessings> characterBlessings,List<UnlockedBlessings> baseAbilityBlessings, int characterIndex, PlayerInformationData playerInformation)
		{
			this.level = level;
			this.xP = xP;
			...
			this.baseAbilityBlessings = new List<UnlockedBlessings>(baseAbilityBlessings);
		...
		public SavableCharacter(SavableCharacterResource data)
		{
			...
			baseAbilityBlessings = new List<UnlockedBlessings>();
			for (int i = 0; i < data.baseAbilityBlessings.Count; i++)
			{
				this.baseAbilityBlessings.Add(new UnlockedBlessings(data.baseAbilityBlessings[i]));
			}
		...
		public SavableCharacter(SavableCharacterResource data, PlayerInformationData playerInformation)
		{
			...
			this.toConfirmAbilities = data.toConfirmAbilities;
			this.baseAbilityBlessings = new List<UnlockedBlessings>();
			for (int i = 0; i < data.baseAbilityBlessings.Count; i++)
			{
				this.baseAbilityBlessings.Add(new UnlockedBlessings(data.baseAbilityBlessings[i]));
			}
